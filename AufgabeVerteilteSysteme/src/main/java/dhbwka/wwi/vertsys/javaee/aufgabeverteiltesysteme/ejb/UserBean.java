...
public class UserBean {
     ...
     */
    public void signup(String username, String password, String name, String anschrift, String plz, String ort, String tel, String email) throws UserAlreadyExistsException {
        if (em.find(User.class, username) != null) {
            throw new UserAlreadyExistsException("Der Benutzername $B ist bereits vergeben.".replace("$B", username));
        }

        User user = new User(username, password, name, anschrift, plz, ort, tel, email);
        user.addToGroup("AufgabeVerteilteSysteme-app-user");
        em.persist(user);
    }
